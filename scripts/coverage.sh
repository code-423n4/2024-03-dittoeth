...
lcov \
    ...
    "EtherscanDiamondImpl.sol" "facets/DiamondLoupeFacet.sol" "facets/DiamondCutFacet.sol" "facets/DiamondEtherscanFacet.sol" "facets/TestFacet.sol" "libraries/console.sol" "libraries/UniswapTickMath.sol" "libraries/LibDiamond.sol" "libraries/PRBMathHelper.sol" "libraries/UniswapOracleLibrary.sol" "libraries/LibDiamondEtherscan.sol"
