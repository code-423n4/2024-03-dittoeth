...
contract AskOrdersSortingTest is OBFixture {
    ...
    function assertEqSellDifferentPricesDifferentAmounts(STypes.Order[] memory order) public {
    ...
    function assertEqSellSamePricesDifferentAmounts(STypes.Order[] memory order, uint256 price) public {
